...
bucket_1 = os.getenv('BUCKET_1')  # Source bucket (image-non-sized-1)
bucket_2 = os.getenv('BUCKET_2')  # Destination bucket (image-sized-1)
sns_topic_arn = os.getenv('SNS_TOPIC_ARN')  # SNS Topic ARN
